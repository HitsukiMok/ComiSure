          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-2xl border border-border bg-surface/50">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="px-3 py-1 bg-yellow-500/20 text-yellow-600 dark:text-yellow-300 rounded-full text-xs font-bold">Funding Needed</span>
              </div>
              <p className="text-sm text-textmuted mb-4">Amount: 500 USDC</p>
              
              <div className="flex gap-4">
                <button className="px-4 py-2 bg-primary text-white rounded-lg text-sm font-bold w-full hover:bg-primary/80 transition-colors">
                  Deposit Funds
                </button>
              </div>
            </div>
